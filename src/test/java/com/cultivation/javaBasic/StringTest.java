...
class StringTest {
    ...
    void should_be_immutable() {
        ...
        // <--start
        final Optional<Boolean> areSame = Optional.of(originalString.hashCode() == modifiedString.hashCode());
        // --end-->
    ...
    void will_create_new_string_when_concat() {
        ...
        // It is really easy to pass the test. But you have to tell why.
        // <--start
        final Optional<Boolean> areSame = Optional.of(originalString.hashCode() == copyOfOriginalString.hashCode());
        // --end-->
    ...
    void should_compare_string_with_different_cases() {
        ...
        // <--start
        Optional<Boolean> actualResultOfEqual = Optional.of(upperCased.contentEquals(lowerCased));
        Optional<Boolean> actualResultOfEqualIgnoreCase = Optional.of(upperCased.toLowerCase().contentEquals(lowerCased));
        // --end-->
